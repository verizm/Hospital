...
class HospitalCommands:
    ...
    def get_status(self) -> None:
        ...
        except UserIdIsNotPositiveIntegerException as user_id_err:
            self._io_helper.response_message(user_id_err.message)

        except UserIsNotExistsException as user_not_exists_err:
            self._io_helper.response_message(user_not_exists_err.message)
